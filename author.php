      ...
      <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                $query1 = "SELECT * FROM post INNER JOIN user ON post.author = user.user_id
                WHERE author = '$aid'";
            ...
            if ($page > 1) {
                ?>
               <li><a href="author.php?page=<?php echo $page - 1?>&aid=<?php echo $aid ?>">Prev</a></li>
               <?php
            }
   ...
   $active = "active";
    ...
    $active = "";
                ...
                ?>
                    ...
                    <li  class="<?php echo $active ?>"><a href="author.php?page=<?php echo $i ?>&aid=<?php echo $aid ?>"><?php echo $i ?></a></li>
                    
                    <?php
}                        if ($total_pages > $page) {
                      ?>
                     <li><a href="author.php?page=<?php echo $page + 1?>&aid=<?php echo $aid ?>">Next</a></li>
                     <?php
                  }
